...
echo "    reality-events  — legacy RE perceptual vectors (${EMBED_DIM_DISPLAY}-dim; engines no longer use Qdrant)"
echo ""
echo "  To start the RealityEngine universe (uses this Qdrant):"
echo "    cd ../RealityEngine_CI && ./startUniverse.sh"
echo ""
echo "Service status:"
echo "$HEALTH"
echo ""
